...
public class GameController {
    ...
    public boolean checkWinning(){
        if (lastColumnIndex==-1) return false;
        ...
        if(lastRowIndex>=3){
            ...
            for (verticalAdjacent = 0; verticalAdjacent <3 ; verticalAdjacent++) {
        ...
        for(ulAdjacent=0;ulAdjacent<3;ulAdjacent++){
        ...
        for(lrAdjacent=0;lrAdjacent<3;lrAdjacent++){
        ...
        for(urAdjacent=0;urAdjacent<3;urAdjacent++){
        ...
        for(llAdjacent=0;llAdjacent<3;llAdjacent++){
